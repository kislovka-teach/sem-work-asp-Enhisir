...
import DialogCreateResumeTag from "../../components/resume/dialogCreateResumeTag/dialogCreateResumeTag";
...
export default function EditResumePage() {
    ...
    return (
        <>
            <DialogCreateResumeTag isOpen={openedModal} onRequestClose={() => {
                setOpenedModal(false);
                setAddedOptions([]);
                setTagSearch("");
            }}>
            ...
            <Feed style={{ paddingBottom: "1.5rem", width: "40vw" }}>
                <Container>
                    ...
                    <div className={classes.verticalGroup}>
                        ...
                        />
                        <div className={[classes.tagContainer, classes.upperBorderBlock].join(" ")}>
                            <h2>Тэги навыков</h2>
