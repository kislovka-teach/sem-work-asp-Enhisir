...
namespace Brah.Data.Migrations
{
    ...
    [Migration("20240502164128_AddedData")]
            ...
            modelBuilder.Entity("Brah.Data.Models.Articles.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            TimePosted = new DateTime(2024, 5, 2, 16, 41, 28, 604, DateTimeKind.Utc).AddTicks(6418),
                            Title = "Text example",
                            TopicId = 1
                        },
                        new
                        {
                            ...
                            Karma = 15,
                            Text = "example example example example example example example example example example example example example example example example example example example example example example example example example",
                            TimePosted = new DateTime(2024, 5, 2, 16, 41, 28, 604, DateTimeKind.Utc).AddTicks(6426),
                        ...
                        new
                        {
                            ...
                            Karma = 15,
                            Text = "example example example example example example example example example example example example example example example example example example example example example example example example example",
                            TimePosted = new DateTime(2024, 5, 2, 16, 41, 28, 604, DateTimeKind.Utc).AddTicks(6428),
